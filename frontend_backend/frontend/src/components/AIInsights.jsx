    ...
    <div className="glass rounded-xl p-4">
      ...
      <ul className="space-y-2 mb-4">
        {aiInsights.map((insight, i) => (
          <li key={i} className="flex items-start gap-2 text-[13px] text-slate-300 leading-snug">
            <Sparkle size={11} className="text-cyan-accent/70 mt-1 shrink-0" strokeWidth={2} />
            {insight}
          </li>
        ))}
      </ul>
      ...
      <div className="flex items-center gap-4 pt-3 border-t border-white/[0.06]">
        <svg width="60" height="60" viewBox="0 0 60 60" className="shrink-0 -rotate-90">
          <circle cx="30" cy="30" r="26" fill="none" stroke="#152438" strokeWidth="5" />
          <circle
            cx="30"
            cy="30"
            r="26"
        ...
        <div>
          <p className="font-display text-lg font-semibold text-slate-100 leading-none">{confidence}%</p>
